...
public class Orientation implements SensorEventListener {
    ...
    private void performMagnetometerCalibrationPhase_1(SensorEvent event) {
    	...
    	if (this.magnetometerEventCounter > 1) {
            ...
            System.out.println("ACCX: " + magnetometerAccuracyX + " ACCY: " + magnetometerAccuracyY);
            System.out.println("OLD0: " + oldMagnetometerValues[0] + " OLD1: " + oldMagnetometerValues[1]);
            System.out.println("EVENT0: " + event.values[0] + " EVENT1: " + event.values[1]);
    ...
    private void checkCalibrationPhase2ErrorCondition(float epsilonX, float epsilonY) {
    	...
    	final float EPSILON_MULTIPLICATOR = 1.6f;
    	float avgdX = 0.0f;
    	float avgdY = 0.0f;
    	...
    	if (sizeX >= MIN_CALIBRATION_POINTS && sizeY >= MIN_CALIBRATION_POINTS ) {
            ...
            System.out.println("EPSILON_MULTIPLICATOR: " + EPSILON_MULTIPLICATOR + " EPSX: " + epsilonX + " EPSY: " + epsilonY);*/
