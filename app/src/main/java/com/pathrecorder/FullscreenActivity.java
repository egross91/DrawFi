...
public class FullscreenActivity extends Activity {
    ...
    {
        try {
        	Bitmap bit = BitmapFactory.decodeResource(this.getResources(), index);
        	return bit;
        } catch (Exception e) {
        	return null;
        } 
	...
	private void setupSketchView() {
        ...
        } catch (NoSuchMethodError ex) { // Older device
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuManager.setBitmapMenuArrow(getBitmapResource(R.drawable.menuarr));
        menuManager.setBitmapMenuButton(getBitmapResource(R.drawable.menubut));
